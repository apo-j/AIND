...
class MinimaxPlayer(IsolationPlayer):
    ...
    def minimax(self, game, depth):
        ...
        **********************************************************************
        ...
        _, move = max([(self.__min_value(game.forecast_move(move), depth - 1), move) for move in legal_moves])
    ...
    def __max_value(self, game, depth):
        ...
        for m in game.get_legal_moves(self):
            max_value = max(max_value, self.__min_value(game.forecast_move(m), depth - 1))
    ...
    def __min_value(self, game, depth):
        ...
        min_value = float('inf')
        for m in game.get_legal_moves(self):
            min_value = min(min_value, self.__min_value(game.forecast_move(m), depth - 1))
...
class AlphaBetaPlayer(IsolationPlayer):
    ...
    def __max_value(self, game, depth, alpha, beta):
        ...
        for move in game.get_legal_moves(self):
            value, _ = self.__min_value(game.forecast_move(move), depth - 1, alpha, beta)
    ...
    def __min_value(self, game, depth, alpha, beta):
        ...
        min_value = float('inf')
        for m in game.get_legal_moves(self):
            value, _ = self.__min_value(game.forecast_move(m), depth - 1, alpha, beta)
    ...
    def alphabeta(self, game, depth, alpha=float("-inf"), beta=float("inf")):
        ...
        **********************************************************************
        ...
        _, move = self.__max_value(game, depth - 1, alpha, beta)
        return move
