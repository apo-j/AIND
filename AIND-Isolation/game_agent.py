...
class MinimaxPlayer(IsolationPlayer):
    ...
    def __max_value(self, game, depth):
        ...
        for m in game.get_legal_moves():
            ...
            max_value = max(max_value, self.__min_value(forecast, depth - 1))
        return max_value
    ...
    def __min_value(self, game, depth):
        ...
        for m in game.get_legal_moves():
            forecast = game.forecast_move(m)
            min_value = min(min_value, self.__max_value(forecast, depth - 1))
...
class AlphaBetaPlayer(IsolationPlayer):
    ...
    def __max_value(self, game, depth, alpha, beta):
        ...
        max_value = float("-inf")
        for m in game.get_legal_moves():
            result = self.__min_value(game.forecast_move(m), depth - 1, alpha, beta)
    ...
    def __min_value(self, game, depth, alpha, beta):
        ...
        min_value = float('inf')
        for m in game.get_legal_moves():
            result = self.__max_value(game.forecast_move(m), depth - 1, alpha, beta)
